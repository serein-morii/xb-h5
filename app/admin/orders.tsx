...
export function OrderEditor({
  ...
  return (
    <form className="mobile-form sheet-editor-form order-editor-form" onSubmit={submit}>
...
export function ShippingEditor({ initial, onSaved, onClose, notify }: { initial: DataRow; onSaved: () => void; onClose: () => void; notify: (message: string, type?: "success" | "error" | "info") => void }) {
  const dictionaries = useContext(DictionaryContext);
