...
export const MOBILE_PAGE_REGISTRY: Record<MenuKey, MobilePageRegistryItem> = {
  ...
  sysRiskIps: { key: "sysRiskIps", label: "风险 IP", description: "全局来源访问控制", icon: ShieldBan },
...
export const DEFAULT_MOBILE_MENU_CONFIG: MobileMenuConfig = {
  ...
  groups: [
    ...
    },
    {
      key: "system",
      title: "系统",
      description: "系统中心入口与本工作台的界面设置",
      items: [
        { key: "systemCenter", label: "系统中心", description: "账号权限、监控与配置（独立子系统）" },
        { key: "mobileMenu" },
      ],
    },
    {
