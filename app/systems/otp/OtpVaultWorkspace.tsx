...
function formatShareValidity(expireTime?: string, now?: number) {
  if (!expireTime) return "临时共享";
  return formatRemaining(expireTime, now || Date.now());
}
