...
const INTERNAL_TARGET_PRESETS: { value: string; label: string; hint?: string }[] = [
  { value: "/order", label: "/order", hint: "公开订单查询（短码 + 验证码）" },
  { value: "/tools", label: "/tools", hint: "免登录工具箱首页" },
  { value: "/tools/order-search", label: "/tools/order-search", hint: "订单查询（手机号 + 验证码）" },
  { value: "/tools/freight-calculator", label: "/tools/freight-calculator", hint: "运费计算" },
  { value: "/tools/freight-compare", label: "/tools/freight-compare", hint: "运费对比" },
];
