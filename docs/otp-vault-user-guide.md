...
flowchart LR
    ...
    Vault --> Settings["我的：账号、外观、安全中心和关于"]
```

在“凭据”页可以搜索系统或账号，也可以切换全部、收藏和我收到的。显示开关、主题和排序在“我的”页的“外观和显示”里。顶栏皮肤切换右侧的小锁用于锁定保险库；未设置锁屏密码时会先进入设置。以后可在「我的 → 安全中心」修改锁屏密码、Passkey 解锁和自动锁屏。
